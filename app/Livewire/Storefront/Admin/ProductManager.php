...
class ProductManager extends Component
{
    ...
    public function saveProduct(): void
    {
        ...
        if ($this->productFeaturedImageUpload) {
            $stored = app(ImageUploadService::class)->replacePublic(
                upload: $this->productFeaturedImageUpload,
                existingPath: $product->featured_image_path,
                directory: 'storefront/products/featured'
            );
    ...
    public function saveCombo(): void
    {
        ...
        if ($this->comboFeaturedImageUpload) {
            $stored = app(ImageUploadService::class)->replacePublic(
                upload: $this->comboFeaturedImageUpload,
                existingPath: $combo->featured_image_path,
                directory: 'storefront/combos'
            );
